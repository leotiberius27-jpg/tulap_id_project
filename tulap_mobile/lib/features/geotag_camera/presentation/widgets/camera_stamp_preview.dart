...
class CameraStampPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (template.id == 'gps_map_camera') {
      // GeotagWatermarkOverlay menggambar kartu & badge-nya SENDIRI (lihat
      // core/imaging/geotag_watermark.dart) - jangan dibungkus Container
      // dekorasi lain di sini, atau kartu akan tampil ganda/bertumpuk.
      final lat = latitude;
      final lng = longitude;
